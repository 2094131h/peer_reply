"""
Django settings for peer_reply_project project.
...
LOGIN_REDIRECT_URL = '/peer_reply/'  # The page you want users to arrive at after they successful log in
LOGIN_URL = '/accounts/login/'  # The page users are directed to if they are not logged in,
                                                                # and are trying to access pages requiring authentication
AUTH_PROFILE_MODULE = 'peer_reply.UserProfile'
...
SECRET_KEY = 'g!x4%*0!bz31!hzw0fv^0m7^f$y&x3f4th79yvr(8s149n^^x4'
...
ROOT_URLCONF = 'peer_reply_project.urls'
